...
1. Перед початков виконання завдання необхідно створити нову гілку. Для цього в
   терміналі необхідно ввести команду `git switch -c назва_гілки` назву задаємо
   по назві секції.
2. Виконуємо завдання.
3. Після виконання завдання необхідно відправити зміни на гітхаб, за допомогою
   послідовних команд: `git add --all` >
   `git commit -m "Completed назва_гілки section"` >
   `git push -U origin назва_гілки`
4. На гітхабі в репозиторії створити пуллреквест та провести його. Нижче будуть
   надані зображення для прикладу. ![images](./assets/images.png)
   ![images](./assets/images.png) ![images](./assets/images.png)
